...
public class Jogo_Da_Velha extends JFrame {
    ...
    public Jogo_Da_Velha() {
        ...
        painelFundo.setBackground(new Color(94, 1, 1));
        painelFundo.setLayout(null);

        add(painelFundo);

        JButton btn = new JButton(" ↲");
        btn.setForeground(new Color(94, 1, 1));
        btn.setBackground(new Color(150,15,8));
        ...
        labelTopo.setBackground(new Color(94, 1, 1));
...
// Adicionar a label ao painel de fundo
    ...
    public void mudar(JButton btn) {
        if (xo) {
            ...
            btn.setText("X");
            xo = true;
            btn.setBackground(new Color(179, 54, 54));
            btn.setForeground(new Color(255,255,255));
        }
        ganhou();
    }
